                            ...
                            <div class="kt-portlet__body">
                                <div class="kt-infobox">
                                    <div class="kt-infobox__header">
                                        <h2 class="kt-infobox__title">Secretaría de Administración y Finanzas</h2>
                                    </div>
                                        ...
                                        <div class="accordion accordion-light  accordion-svg-icon" id="accordionExample3">
                                            <div class="card">
                                                ...
                                                <div id="collapseOne3" class="collapse show" aria-labelledby="headingOne3" data-parent="#accordionExample3">
                                                    <div class="card-body">
                                                        Este sitio web fue diseñado por el Gobierno de la CDMX a través de la Dirección General de Mensaje y Nuevas Tecnologías, la Dirección General de Gobernabilidad de Tecnologías de la Información y Comunicaciones ambas de la Oficialía Mayor y la Dirección General de Informática de la Secretaría de Finanzas. Los contenidos son administrados por la Secretaría de Finanzas de la CDMX. El presente sitio tienen como finalidad presentar a la ciudadanía los servicios, programas e información en general otorgada por el Gobierno de la Ciudad de México a través de esta dependencia. Bajo ninguna circunstancia deberá entenderse su contenido con fines proselitistas o de propaganda política. El sitio fue liberado el 11 de julio de 2016 en su versión 1.0 y se encuentra en permanente desarrollo y mejora. Cualquier reporte de error o sugerencia puedes realizarlo a cms@cdmx.gob.mx.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card">
                                                <div class="card-header" id="headingTwo3">
                                                    <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo3" aria-expanded="false" aria-controls="collapseTwo3">
                                                        ...
                                                        </svg> Sobre el Gobierno de la Ciudad de México
                                                    </div>
                                                </div>
                                                <div id="collapseTwo3" class="collapse" aria-labelledby="headingTwo3" data-parent="#accordionExample3">
                                                    <div class="card-body">
                                                        El Gobierno de la Ciudad de México está conformado por la totalidad de las dependencias de la administración pública centralizada, desconcentrada, descentralizada y órganos autónomos previstos en la Ley Orgánica de la Administración Pública del Distrito Federal y demás leyes administrativas vigentes en la Ciudad de México, bajo la dirección del Jefe de Gobierno tal como lo determina la Constitución Política de los Estados Unidos Mexicanos y el Estatuto Orgánico del Distrito Federal. Igualmente, la Ciudad de México ha asumido un compromiso con la modernización y apertura de sus sistemas electrónicos a lo cual está obligada en los términos de la Ley de Gobierno Electrónico del Distrito Federal y la Ley para hacer de la Ciudad de México una ciudad más abierta.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card">
