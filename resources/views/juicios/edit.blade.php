                            ...
                            <div class="accordion" id="acordionjuicio">
                                    ...
                                    <div class="card-header" id="datosjuicio">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                                ...
                                                <i class="fa-solid fa-book" style="color: #8b1818;"></i>- Datos
                                                Generales del JuicioXD
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <input type="date" min="2016-01-01"
                                                                    class="form-control" id="notidemanda"
                                                            ...
                                                            <div class="card-body">
                                                                <p class="card-text">
                                                                    <input type="number" class="form-control"
                                                                        id="clasificacion_exp"
                                                                        name="clasificacion_exp" placeholder="----"
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <select class="custom-select" id="adscripcion"
                                                                    name="adscripcion">
                                                                    <option selected disabled value="">Selecicona
                                                                        la Adscripcion</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        COMISION EJECUTIVA DE ATENCION A VICTIMAS Y
                                                                        OTROS</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="DATOS DE LA RELACIÓN LABORAL">DATOS DE
                                                                        LA RELACIÓN LABORAL</option>
                                                                    <option
                                                                        @if ($juicio3[0]->adscripcion == 'DESPLEGABLE CON MODIFICACIÓN') {{ 'selected' }} @endif
                                                                        value="DESPLEGABLE CON MODIFICACIÓN">
                                                                        DESPLEGABLE CON MODIFICACIÓN</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        Dirección general de Análisis y Prospectiva para
                                                                        la Poítica de Interior</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        Dirección General De Coordinación Para La
                                                                        Operación Territorial</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        Atención de Derechos Humanos</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        Dirección General de Infraestructura Tecnologica
                                                                        de Seguridad Pública</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        Y Eficiencia Administrativa</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        Dirección General de Política Pública de
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        Información y Comunicaciones</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        Dirección General del Registro Nacional de
                                                                        Población e Identificación Personal</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="Ecoblue de México, S.A. de C.V.">Ecoblue
                                                                        de México, S.A. de C.V.</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="GUAIDA, S A DE C.V. Y/O">GUAIDA, S A DE
                                                                        C.V. Y/O</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        los Trabajadores del Estado</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="No prestaba servicios en SEGOB">No
                                                                        prestaba servicios en SEGOB</option>
                                                                    <option
                                                                        @if ($juicio3[0]->adscripcion == 'Oficialia Mayor') {{ 'selected' }} @endif
                                                                        value="Oficialia Mayor">Oficialia Mayor
                                                                    </option>
                                                                    <option
                                                                        @if ($juicio3[0]->adscripcion == 'Oficina del C. Secretario') {{ 'selected' }} @endif
                                                                        value="Oficina del C. Secretario">Oficina del
                                                                        C. Secretario</option>
                                                                    <option
                                                                        @if ($juicio3[0]->adscripcion == 'Órgano Interno de Control') {{ 'selected' }} @endif
                                                                        value="Órgano Interno de Control">Órgano
                                                                        Interno de Control</option>
                                                                    <option
                                                                        @if ($juicio3[0]->adscripcion == 'Policía Federal') {{ 'selected' }} @endif
                                                                        value="Policía Federal">Policía Federal
                                                                    </option>
                                                                    <option
                                                                        @if ($juicio3[0]->adscripcion == 'Prevención y Readapción Social') {{ 'selected' }} @endif
                                                                        value="Prevención y Readapción Social">
                                                                        Prevención y Readapción Social</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        de Publicaciones y Revistas Ilustradas</option>
                                                                    <option
                                                                        ...
                                                                        Secretaria Tecnica Para La Implementacion De
                                                                        Sistema De Justicia Penal</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="Servicio de Protección Federal">Servicio
                                                                        de Protección Federal</option>
                                                                    <option
                                                                        @if (
                                                                            $juicio3[0]->adscripcion ==
                                                                        ...
                                                                        INTEGRAL DE LA FAMILIADE JIUTEPEC MORELOS]
                                                                        JUICIO RADICADO EN EL TECA DE MORELOS</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="Subsecretaría de Gobierno">Subsecretaría
                                                                        de Gobierno</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="Unidad de Enlace">Unidad de Enlace
                                                                    </option>
                                                                    <option
                                                                        @if ($juicio3[0]->adscripcion == 'Unidad de Enlace Federal') {{ 'selected' }} @endif
                                                                        value="Unidad de Enlace Federal">Unidad de
                                                                        Enlace Federal</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="Unidad de Normatividad de Medios">Unidad
                                                                        de Normatividad de Medios</option>
                                                                    <option
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="Unidad General de Asuntos Jurídicos">
                                                                        Unidad General de Asuntos Jurídicos</option>
                                                                    <option
                                                                        @if ($juicio3[0]->adscripcion == 'Unidad para el Desarrollo Político') {{ 'selected' }} @endif
                                                                        value="Unidad para el Desarrollo Político">
                                                                        Unidad para el Desarrollo Político</option>
                                                                    <option
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <p class="card-text">
                                                                    ...
                                                                    <input type="date" min="2016-01-01"
                                                                        class="form-control" id="juicio_in_rellaboral"
                                ...
                                <div class="card">
                                    <div class="card-header" id="stramite">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button"
                                                data-toggle="collapse" data-target="#tramite" aria-expanded="false"
                                                aria-controls="tramite">
                                                <i class="fa-sharp fa-solid fa-file-invoice"
                                                    style="color: #8b1818;"></i> - Tramite
                                            </button>
                                        </h5>
                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <p class="card-text">
                                                                    <input type="date" min="2016-01-01"
                                                                        class="form-control" id="Solicitud"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <p class="card-text">
                                                                    <input type="date" min="2016-01-01"
                                                                        class="form-control" id="Devolucion"
                                ...
                                <div class="card">
                                    <div class="card-header" id="laudos">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button"
                                                data-toggle="collapse" data-target="#laudo" aria-expanded="false"
                                                aria-controls="laudo">
                                                <i class="fa-sharp fa-solid fa-file-invoice"
                                                    style="color: #8b1818;"></i> - Laudo
                                            </button>
                                        </h5>
                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <p class="card-text">
                                                                    <input type="date" min="2016-01-01"
                                                                        class="form-control" id="lau_fecha"
                                ...
                                <div class="card">
                                    <div class="card-header" id="amparos">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button"
                                                data-toggle="collapse" data-target="#amparo" aria-expanded="false"
                                                aria-controls="amparo">
                                                <i class="fa-sharp fa-solid fa-file-invoice"
                                                    style="color: #8b1818;"></i> - Amparo
                                            </button>
                                        </h5>
                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <p class="card-text">
                                                                <input type="date" class="form-control"
                                                                    id="parte" value="{{ $juicio3[0]->parte }}"
                                                                    name="parte">
                                                            </p>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <p class="card-text">
                                                                <input class="form-control" type="text"
                                                                    id="ad_dt"
                                                                    placeholder="Sin Dato por el Momento"
                                                                    name="ad_dt" value="{{ $juicio3[0]->ad_dt }}">
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="card-body">
                                                            <p class="card-text">
                                                                <input class="form-control" type="text"
                                                                    id="abogados_asignados"
                                                                    placeholder="Sin Dato por el Momento"
                                                                    value="{{ $juicio3[0]->parte_adherente }}">
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingThree">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed" type="button"
                                                    data-toggle="collapse" data-target="#ejecucion"
