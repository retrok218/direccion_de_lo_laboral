                                                ...
                                                <select class="custom-select" id="denominacion" name="denominacion">
                                                  @foreach ($catdenomicacion as $deno)
                                                      @if ($deno==$juicio3[0]->denominacion)
                                                          <option selected value={{$deno}}>{{$deno}}</option>
                                                      @else
                                          ...
                                          <div class="card">
                                           ...
                                           @php
                                              $puestcatalogo = [
                                                  ...
                                                  "Agende Federal de Migración",
                                                  "Agente de Protección al Inmigrante",
                                                  "AGENTE DE PROTECCION AL MIGRANTE",
                                                  "Agente Federal de Migración",          
                                                  "Agente Federal de Migración B",
                                                  "Agregada Administativa C, en los Ángeles",
                                                  "Analista Especializado en Servicios Migratorios",
                                                  "Analista PRS administrativo",
                                                  "Analista PRS Administrativo FC",
                                                  "Analista técnico nivel 6",
                                                  "Asistente de Áreas de Servicios Migratorios",
                                                  "Auxiliar Administrativo PRS de SG",
                                                  "Auxiliar en SG y mantenimiento PRS",
                                                  "Chofer",
                                                  "Cocinero penitenciario B",
                                                  "Codinador de Unidad de Áreas de Servicios Migratorios ",
                                                  "Coordinadora",
                                                  "Dictaminador de Asuntos Migratorios",
                                                  "Dir. Área",
                                                  "DIR. GRAL.",
                                                  "DIR. GRAL. ADJ.",
                                                  "Dirección",
                                                ...
                                                @endphp
                                              <input  type="text" list="puestoitem" class="form-control"  placeholder="Ingresa El Puesto" id="puesto" name="puesto" value=" {{$juicio3[0]->puesto}}" > 
                                                <datalist class="custom-datalist" id="puestoitem"> 
                                                  @foreach ($puestcatalogo as $puestoc)
                                                    @if ($puestoc == $juicio3[0]->puesto)
                                                        <option selected value={{$puestoc}}>{{$puestoc}}</option>
                                                    @else
                                                        <option value="{{$puestoc}}">{{$puestoc}}</option>
                                                    @endif                                                    
                                                  @endforeach
                                                </datalist>                                                   
                                              </p>                                    
                                        ...
                                        <div class="col-sm-4">
                                          <div class="card">
                                            ...
                                            <div class="card-body">
                                              ...
                                              @endphp
                                              <p class="card-text">
                                                <input  type="number" class="form-control input_dinero" name="salarioMen" id="salarioMen"   data-type="currency" placeholder="1000,000.00" min="1" value="{{$juicio3[0]->nivel}}">
                                                <datalist class="custom-datalist" id="niveles"> 
                                                      @foreach ($nivelcat as $nivc)
                                                            @if ($nivc == $juicio3[0]->nivel)
                                                              <option selected value={{$nivc}}>{{$nivc}}</option>
                                                            @else
                                                              <option value="{{$nivc}}">{{$nivc}}</option>
                                                            @endif                                                                       
                                                      @endforeach
                                                </datalist>
                                              </p>                                    
                                            ...
                                            <div class="card-body">
                                              ...
                                              <p class="card-text">
                                                 ...
                                                 <div class="input-group">
                                                  ...
                                                  <input   type="text" class="form-control " name="salarioMen" id="salarioMen"   data-type="currency" value="{{$juicio3[0]->salarioMen}}" >
                                                </div>                                                  
                                              </p>                                    
                                            </div>
                                          </div>
                                            ...
                                            <div class="card">
                                              ...
                                              <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                  ...
                                                  <input type="number" class="form-control" id="Fojas" name="Fojas" placeholder="0"  value="{{$juicio3[0]->fojas}}"  >
                                                </p>                                    
                                              </div>
                                            </div>
                                          </div>
                                            ...
                                            <div class="card">
                                              ...
                                              <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                  ...
                                                  <input type="date" class="form-control" id="exp_adscripcion_devolucion" name="exp_adscripcion_devolucion" value="{{$juicio3[0]->exp_adscripcion_devolucion}}" >                                          
                                                </p>                                    
                                              </div>
                                            </div>
                                          </div>                                                                                             
                                            ...
                                            <div class="card">
                                              ...
                                              <div class="card-body">                                      
                                                <p class="card-text">
                                                  ...
                                                  <input type="date" class="form-control" id="Cierre_de_Instruccion" name="Cierre_de_Instruccion"value="{{$juicio3[0]->cierredeinstruccion}}"  >                                         
                                                </p>                                    
                                              </div>
                                            </div>
                                          </div>                                                                                             
                                    ...
                                    <div class="card-deck">        
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                                  
                                            <p class="card-text">                                     
                                              ...
                                              <select class="custom-select" id="reinstalacion" name="reinstalacion">
                                                <option @if($juicio3[0]->reinstalacion == "Si") {{"selected"}} @endif value="Si">Si</option>
                                                <option @if($juicio3[0]->reinstalacion == "No") {{"selected"}} @endif value="No">No</option>
                                              </select> 
                                      ...
                                      <div class="col-sm-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                                 
                                            <p class="card-text">                                                                                   
                                              <select class="custom-select" id="indemnizacion" name="indemnizacion">
                                                <option @if($juicio3[0]->indemnizacion == "Si") {{"selected"}} @endif value="Si">Si</option>
                                                <option @if($juicio3[0]->indemnizacion == "No") {{"selected"}} @endif value="No">No</option>
                                              </select>                                       
                                            </p>                                    
                                          </div>
                                        </div>
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                                 
                                            <p class="card-text">
                                                <div class="input-group">
                                                  <div class="input-group-prepend"><span class="input-group-text">$</span></div>
                                                    <input type="text" class="form-control"  placeholder="Sin Dato por el Momento" aria-describedby="basic-addon1" value="{{$juicio3[0]->pasivo_total}}" name="pasivo_total" id="pasivo_total">
                                                </div>                                                                                                                        
                                            </p>                                    
                                          </div>
                                        </div>
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              ...
                                              <input type="date" class="form-control" id="f_notificacion_laudo" value="{{$juicio3[0]->f_notificacion_laudo}}"  name="f_notificacion_laudo">
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>                                                    
                                  ...
                                  <div class="row ">                                         
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                                                                                                         
                                              <input type="date"   class="form-control" id="parte" value="{{$juicio3[0]->parte}}"  name="parte"> 
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              ...
                                              <select name="dir_indir" id="dir_indir"  class="custom-select">
                                                <option @if ($juicio3[0]->dir_indir == "Directo") {{"selected"}} @endif>Directo</option>    
                                                <option @if ($juicio3[0]->dir_indir == "Indirecto") {{"selected"}} @endif>Indirecto</option> 
                                              </select>
                                            </p>                                    
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              <input  class="form-control" type="text" id="ad_dt" placeholder="Sin Dato por el Momento" name="ad_dt" value="{{$juicio3[0]->ad_dt}}" name="ad_dt" >                                      
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              <input  class="form-control" type="text" id="conceptode" placeholder="Sin Dato por el Momento" value="{{$juicio3[0]->conceptode}}" name="conceptode"  >                                      
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              ...
                                              <input type="date" class="form-control" id="aud_const2" value="{{$juicio3[0]->aud_const2}}"  name="aud_const2">
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              ...
                                              <input type="date" class="form-control" id="fecha_sentencia" value="{{$juicio3[0]->fecha_sentencia}}"  name="fecha_sentencia">
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-5">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                                                                                                        
                                              <select class="custom-select" id="sentido_sentencia" name="sentido_sentencia" >                                                
                                                <option @if ($juicio3[0]->sentido_sentencia == "Ampara y Protege") {{"selected"}} @endif>Ampara y Protege Actor</option>
                                                <option @if ($juicio3[0]->sentido_sentencia == "No Ampara Ni Protege") {{"selected"}} @endif>No Ampara Ni Protege"</option> 
                                                <option @if ($juicio3[0]->sentido_sentencia == "Niega") {{"selected"}} @endif>Niega</option>                         
                                              </select> 
                                            </p>                                    
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              <input  class="form-control" type="text" id="recurso_amparo" placeholder="Sin Dato por el Momento" value="{{$juicio3[0]->recurso_amparo}}" name="recurso_amparo"  >                                      
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                                                                  
                                              <select class="custom-select" id="parte_adherente" name="parte_adherente">
                                                <option @if($juicio3[0]->parte_adherente == "Trabajador") {{"selected"}} @endif value="Trabajador">Trabajador</option>
                                                <option @if($juicio3[0]->parte_adherente == "Segob") {{"selected"}} @endif value="Segob">Segob</option>
                                              </select>                                                                                   
                                            </p>                                    
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                                                                   
                                              <select class="custom-select" id="sentido_ad" name="sentido_ad">
                                                <option @if($juicio3[0]->sentido_ad == "Concede") {{"selected"}} @endif value="Concede">Trabajador</option>
                                                <option @if($juicio3[0]->sentido_ad == "Niega") {{"selected"}} @endif value="Niega">Segob</option>
                                              </select>                                      
                                            </p>                                    
                                          </div>
                                        </div>
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              ...
                                              <input type="date" class="form-control" id="fecha_ad" value="{{$juicio3[0]->fecha_ad}}"  name="fecha_ad">                                    
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>                                                                              
                                    ...
                                    <div class="card-deck">
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              ...
                                              <input type="date" class="form-control" id="fechacumpreinstalacion" value="{{$juicio3[0]->fechacumpreinstalacion}}"  name="fechacumpreinstalacion">                                   
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              ...
                                              <input type="date" class="form-control" id="notf2" value="{{$juicio3[0]->notf2}}"  name="notf2">   
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              ...
                                              <input type="date" class="form-control" id="r_h" value="{{$juicio3[0]->r_h}}"  name="r_h">                                    
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                                                                                               
                                                <input type="date" class="form-control" id="vence" value="{{$juicio3[0]->vence}}"  name="vence">  
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              ...
                                              <select class="custom-select" id="sentido" name="sentido">
                                                <option selected disabled value="">Selecicona</option>
                                                <option @if($juicio3[0]->sentido == "Allana") {{"selected"}} @endif value="Allana">Allana</option>
                                                <option @if($juicio3[0]->sentido == "Alta") {{"selected"}} @endif value="Alta">Alta</option>
                                                <option @if($juicio3[0]->sentido == "Baja") {{"selected"}} @endif value="Baja">Baja</option>
                                              </select> 
                                      ...
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              <input  class="form-control" type="date" id="solicitadoarh" placeholder="Sin Dato por el Momento" value="{{$juicio3[0]->solicitadoarh}}" name="solicitadoarh"  >
                                      ...
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            ...
                                            <div class="input-group">
                                                  <div class="input-group-prepend"><span class="input-group-text">$</span></div>
                                                  <input  class="form-control" type="number" id="cantidad"  min="1" value="{{$juicio3[0]->cantidad}}" 
                                                    name="cantidad" >
                                            </div>                                                                                                                                  
                                            </p>                                    
                                          </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              <input  class="form-control" type="text" id="folio" placeholder="Sin Dato por el Momento" value="{{$juicio3[0]->folio}}" name="folio"  >                                      
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              <input  class="form-control" type="text" id="nodeintento" placeholder="Sin Dato por el Momento" name="nodeintento" value="{{$juicio3[0]->nodeintento}}"  >                                      
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              <input  class="form-control" type="date" id="fechaproxima" name="fechaproxima" placeholder="Sin Dato por el Momento" value="{{$juicio3[0]->fechaproxima}}"  >                                      
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              <input  class="form-control" type="date" id="cumplimiento" placeholder="Sin Dato por el Momento" name="cumplimiento" value="{{$juicio3[0]->cumplimiento}}"  >                                      
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>                            
                                    ...
                                    <div class="card-deck">
                                      <div class="col-lg-6">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              <input  class="form-control" type="date" id="mesdegobconclusion" name="mesdegobconclusion" placeholder="Sin Dato por el Momento" value="{{$juicio3[0]->mesdegobconclusion}}"  >                                      
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-lg-6">
                                        <div class="card">
                                          ...
                                          <div class="card-body">                               
                                            <p class="card-text">                                     
                                              <input  class="form-control" type="date" id="fecha_conclusion" name="fecha_conclusion" placeholder="Sin Dato por el Momento" value="{{$juicio3[0]->fecha_conclusion}}"  >                                      
                                            </p>                                    
                                          </div>
                                        </div>
                                      </div>
