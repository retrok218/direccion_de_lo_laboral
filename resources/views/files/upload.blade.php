		...
		<div class="kt-portlet__body">
			<div class="form-group row">
				...
				<div class="col-lg-4 col-md-9 col-sm-12">
					<div class="dropzone dropzone-success" id="kt_dropzone_1">
...
var KTDropzoneDemo = function () {
    ...
    var demo1 = function () {
        ...
        $('#kt_dropzone_1').dropzone({
            url: url+"files/store", // Set the url for your upload script location
            headers: {
            ...
            init: function() {
                this.on("success", function(file, response) {
                    ...
                    if(response.estatus=='true'){
                        Swal.fire('¡Alerta!', "Se subio correctamente", 'success');
