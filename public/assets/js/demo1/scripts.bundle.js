...
var KTUtil = (function () {
    ...
    return {
        ...
        hasFixedPositionedParent: function (t) {
            for (; t && t !== document; ) {
                if (
                    ((position = KTUtil.css(t, "position")),
                    "fixed" === position)
                )
                    return !0;
                t = t.parentNode;
                ...
                r = {
                    ...
                    handleSubmenuDropdownClick: function (t) {
                        if ("accordion" !== r.getSubmenuMode(this)) {
                            ...
                            "accordion" !=
                                ...
                                (!1 ===
                                KTUtil.hasClass(e, "kt-menu__item--hover")
                                    ? (KTUtil.addClass(
                                          e,
                    ...
                    handleSubmenuDropdownClose: function (t, e) {
                        if ("accordion" !== r.getSubmenuMode(e)) {
                            ...
                            if (
                                ...
                                0 ===
                                    e.querySelectorAll(".kt-menu__toggle")
                                        .length
                            )
                    ...
                    handleSubmenuAccordion: function (t, e) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    !1 ===
                                    KTUtil.hasClass(o, "kt-menu__item--open")
                                ) {
                    ...
                    scrollToItem: function (t) {
                        KTUtil.isInResponsiveRange("desktop") &&
                            ...
                            KTUtil.scrollTo(
                                t,
                                a.options.accordion.autoScrollSpeed
                            );
                    },
                    ...
                    resetActiveItem: function (t) {
                        for (
                            ...
                            KTUtil.removeClass(r, "kt-menu__item--active"),
                                KTUtil.hide(
                                    KTUtil.child(r, ".kt-menu__submenu")
                                );
                            for (
                                var s = 0,
                                    d = (n =
                ...
                o = {
                    ...
                    toggleOn: function () {
                        return (
                            ...
                            a.togglerState &&
                                KTUtil.addClass(n, a.togglerState),
                            (a.state = "on"),
                    ...
                    toggleOff: function () {
                        return (
                            ...
                            a.togglerState &&
                                KTUtil.removeClass(n, a.togglerState),
                            (a.state = "off"),
                ...
                o = {
                    ...
                    init: function (t) {
                        (a.element = n),
                            ...
                            a.options.startStep > 1 &&
                                o.goTo(a.options.startStep),
                            o.updateUI();
                    },
                    build: function () {
            ...
            if (e) {
                ...
                var a = function () {
                    ...
                    if (0 !== n.value.length) {
                        ...
                        var o,
                            l =
                                '<div class="kt-chat__user"><span class="kt-chat__datetime">Just now</span><a href="#" class="kt-chat__username">Jason Muller</span></a><span class="kt-userpic kt-userpic--circle kt-userpic--sm"><img src="./assets/media/users/100_12.jpg" alt="image"></span></div><div class="kt-chat__text kt-bg-light-brand">' +
                                n.value;
                        KTUtil.setHTML(i, l),
                            a.appendChild(i),
                            (n.value = ""),
